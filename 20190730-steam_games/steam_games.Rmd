...
steam_games %>% 
  ...
  labs(x = NULL,
       ...
       title = "Distribution of game ownership for publishers with more than 80 titles",
       subtitle = "A few companies focus on niche audiences with low mass market appeal",
       caption = "by: @eeysirhc\nsource: Steam Spy") +
